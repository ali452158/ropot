...
# CopyFactory — set this AFTER creating a strategy in app.metaapi.cloud → CopyFactory → Strategies
# Leave empty for now; you'll set it after running /api/admin/copyfactory/status to find the strategy ID.
